...
The Book Exchange Platform is currently deployed on Vercel. You can access the live version of the app by following this link: <a href="https://bookapp-zeta.vercel.app/">Book Exchange platform on Vercel</a>.

## Features

The Book Exchange Platfrm provides the following features:
...
The Book exchange platform was built using the following technologies:
